      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField 
            ...
            name="email"
            label="Email"
            placeholder="n.softnhdev@gmail.com"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField 
            ...
            placeholder="Peanuts, Eggs, Pollen"
          />
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField 
            ...
            placeholder="Any family medical history (if any)"
          />
